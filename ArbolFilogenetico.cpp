...
void ArbolFilogenetico::busquedaLocal(vector<NodoArbol*> &listaHojas){
    ...
    NodoArbol* direccionHoja3;
    char baseNitrogenadaAuxiliar;
    ...
    do{
        posHoja3 = rand() % listaHojas.size();
    }while(posHoja1 == posHoja3 && posHoja2 == posHoja3);    

    direccionHoja1 = listaHojas[posHoja1];
    direccionHoja2 = listaHojas[posHoja2];
    direccionHoja3 = listaHojas[posHoja3];

    //cout << "\nBase hoja 1: " << direccionHoja1->baseNitrogenada << " Base hoja 2: " << direccionHoja2->baseNitrogenada << " Base hoja 3: " << direccionHoja3->baseNitrogenada << endl;

    //Se intercambian las bases entre los nodos seleccionados.
    direccionHoja1->baseNitrogenada = direccionHoja1->baseNitrogenada ^ direccionHoja3->baseNitrogenada;
    direccionHoja3->baseNitrogenada = direccionHoja1->baseNitrogenada ^ direccionHoja3->baseNitrogenada;
    direccionHoja1->baseNitrogenada = direccionHoja1->baseNitrogenada ^ direccionHoja3->baseNitrogenada;
    ...
    //cout << "Base hoja 1: " << direccionHoja1->baseNitrogenada << " Base hoja 2: " << direccionHoja2->baseNitrogenada <<  " Base hoja 3: " << direccionHoja3->baseNitrogenada << endl;

    direccionHoja1->evaluarMutacionHoja();
    direccionHoja2->evaluarMutacionHoja();
    direccionHoja3->evaluarMutacionHoja();
